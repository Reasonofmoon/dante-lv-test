...
const ResultDashboard: React.FC<ResultDashboardProps> = ({ results, levelInfo, onRetake }) => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `IELTS_Level_Test_Report_${new Date().toISOString().split('T')[0]}`,
  });
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div ref={componentRef} className="print:p-8 print:max-w-none">
        {/* Header Section */}
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-sm text-gray-400 print:block hidden">Date: {new Date().toLocaleDateString()}</p>
        </div>

        {/* Main Score Card */}
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 print:shadow-none print:border" style={{ borderColor: levelInfo.color }}>
          <div className="p-8 grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-gray-50 p-3 rounded-xl border border-gray-100 print:bg-white print:border-gray-300">
              ...
              <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 flex items-center justify-between print:bg-white print:border-gray-300">
                 <div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-8">
          <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 print:shadow-none print:border">
            <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
              <span className="text-2xl">🎯</span> Action Plan
            </h3>
            <ul className="space-y-3">
              {levelInfo.recommendations.map((rec: string, i: number) => (
                <li key={i} className="flex items-start gap-3 text-gray-700 bg-gray-50 p-3 rounded-lg print:bg-white print:border print:border-gray-200">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white p-6 rounded-xl shadow-md print:bg-white print:text-black print:border print:border-gray-300 print:shadow-none">
            <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
              <span className="text-2xl">🚀</span> Next Steps
            </h3>
            <p className="text-gray-300 mb-6 leading-relaxed print:text-gray-700">
            ...
            <button 
              onClick={onRetake}
              className="w-full py-3 bg-white text-gray-900 rounded-lg font-bold hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 print:hidden"
            >
